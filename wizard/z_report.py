    ...
    def get_sale_details(self,sessions=False,company=False):
        ...
        if sessions:
            orders = self.env['pos.order'].search([
                ...
                ('session_id', 'in', sessions.ids)], order="pos_reference asc")
            dic_fac.setdefault(0,['Factura inicial:',orders[0].pos_reference,orders[0].date_order])
            dic_fac.setdefault(1,['Factura final:',orders[-1].pos_reference,orders[-1].date_order])
